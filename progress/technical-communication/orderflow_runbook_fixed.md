...
**Last verified:** [DATE] by [NAME] -- all steps executed against production
**Last updated:** [DATE]
...
If you get no response at all (timeout or connection refused), skip to Step 5.
...
- TimeoutError -- downstream service is slow (go to Step 4)
- 500 Internal Server Error -- application bug (go to Step 6)
...
If the auth service is down, OrderFlow cannot validate tokens.
